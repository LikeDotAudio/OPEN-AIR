...
//!
//! This crate is **declared intent, not working code**. Superseded in practice by `openair-dnssd`, which is implemented and does the live mDNS browsing. This crate is a placeholder and may be retired.
//!
