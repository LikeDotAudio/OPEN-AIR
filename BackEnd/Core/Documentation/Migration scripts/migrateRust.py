...
CRATES = [
    ...
    "oaFileHandlers.oaFileImportCSV/Methods/oaCSVParser_rs",
    "oaFileHandlers.oaFileImportHTML/Methods/oaHTMLScraper_rs",
    "oaFileHandlers.oaFileImportPDF/Methods/oaPDFParser_rs",
    "oaFileHandlers.oaFileImportShow/Methods/oaShowfileUnpacker_rs",
