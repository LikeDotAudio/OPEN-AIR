...
| 2026-07-17 | add | — | `FrontEnd/comMQTT/MqttProvider.jsx` LWT + v41 dual heartbeat | (this commit) | Step 3d: additive only; will targets `OpenAir/System/Agents/web-{guid}` per H2; legacy Failover beat unchanged; LWT kill-test verified against live broker (browser kill-tab spot-check recommended) |
