const AudioEditor = ({ label = "Wave Audio Editor" }) => {
    ...
    return (
        <div
            ...
            style={{ padding: '20px', backgroundColor: 'rgba(18,18,18,0.28)', borderRadius: '4px', color: '#fff', border: dragOver ? '1px dashed #f4902c' : '1px solid #333', width: '100%', boxSizing: 'border-box', position: 'relative' }}
        >
            {dragOver && (
