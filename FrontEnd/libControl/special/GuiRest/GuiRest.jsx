/**
 * Header: GuiRest.jsx
 * Purpose: GuiRest component or utility.
 * Description: Handles logic and rendering for GuiRest component or utility.
 * 
 * Version: 26.07.05.1
 * Change Log:
...
// React implementation for GuiRest
// Replaces left_50/top_100/4_Protocals/44_REST/gui_REST.py

window._GuiRest = (props) => {
    ...
    return (
        <div style={{ padding: '20px', color: '#fff', backgroundColor: '#222', borderRadius: '5px', height: '100%', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ color: '#f4902c', marginTop: 0 }}>GuiRest</h3>
...
window.OA_COMPONENTS['_GuiRest'] = window._GuiRest;
