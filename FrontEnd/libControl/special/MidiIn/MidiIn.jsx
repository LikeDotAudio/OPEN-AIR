// React implementation for MidiIn
// Replaces left_50/top_100/4_Protocals/50_MIDI/1_Input/Midi_In.py

window._MidiIn = (props) => {
    ...
    return (
        <div style={{ padding: '20px', color: '#fff', backgroundColor: '#222', borderRadius: '5px', height: '100%', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ color: '#f4902c', marginTop: 0 }}>MidiIn</h3>
...
window.OA_COMPONENTS['_MidiIn'] = window._MidiIn;
