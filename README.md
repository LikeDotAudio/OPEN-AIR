...
Refer to [managers/configini/config_reader](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/configini/config_reader.md) for deep configuration details.
...
├-----**Display/**<br>
     ...
     ├----> **breakoff_manager/**<br>
        |   -> [hidden_breakoff_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/breakoff_manager/hidden_breakoff_manager.md) — *Hidden Breakoff Manager*<br>
     ├----> **builder/**<br>
        ...
        |   -> [gui_batch_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/builder/gui_batch_builder.md) — *Gui Batch Builder*<br>
        |   -> [gui_display](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/builder/gui_display.md) — *Gui Display*<br>
        |   -> [gui_mqtt_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/builder/gui_mqtt_manager.md) — *Gui Mqtt Manager*<br>
        |   -> [gui_rebuilder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/builder/gui_rebuilder.md) — *Gui Rebuilder*<br>
        |   -> [window_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/builder/window_manager.md) — *Window Manager*<br>
     ├----> **context/**<br>
     ...
     ├----> **factory/**<br>
        |   -> [asset_cache_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/factory/asset_cache_manager.md) — *Asset Cache Manager*<br>
     ...
     ├----> **parser/**<br>
        ...
        |   -> [gui_batch_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/parser/gui_batch_builder.md) — *Gui Batch Builder*<br>
        ...
        |   -> [gui_mqtt_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/parser/gui_mqtt_manager.md) — *Gui Mqtt Manager*<br>
        |   -> [gui_rebuilder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/parser/gui_rebuilder.md) — *Gui Rebuilder*<br>
        ...
        |   -> [gui_style_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/parser/gui_style_manager.md) — *Gui Style Manager*<br>
     ...
     ├----> **styling/**<br>
        |   -> [gui_style_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/styling/gui_style_manager.md) — *Gui Style Manager*<br>
     ├----> **telemetry/**<br>
        |   -> **geometry_snitch/**<br>
             ...
             ├------->[hidden_geometry_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/telemetry/geometry_snitch/hidden_geometry_manager.md) — *Hidden Geometry Manager*<br>
        |   -> **visibility_snitch/**<br>
             ├------->[hidden_visibility_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/telemetry/visibility_snitch/hidden_visibility_manager.md) — *Hidden Visibility Manager*<br>
     ...
     ├----> **transparency/**<br>
        |   -> [transparency_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Display/transparency/transparency_manager.md) — *Transparency Manager*<br>
...
├-----**PTP/**<br>
     ...
     ├----> [ptp_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/PTP/ptp_manager.md) — *Ptp Manager*<br>
├-----**System_Core/**<br>
...
├-----**Visa_Fleet_Manager/**<br>
     ├----> **Prototype/**<br>
        |   -> [cli_visa_find](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/Prototype/cli_visa_find.md) — *Cli Visa Find*<br>
     ├----> [manager_fleet_mqtt_bridge](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_fleet_mqtt_bridge.md) — *Manager Fleet Mqtt Bridge*<br>
     ├----> [manager_visa_Search](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_visa_Search.md) — *Manager Visa Search*<br>
     ├----> [manager_visa_csv_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_visa_csv_builder.md) — *Manager Visa Csv Builder*<br>
     ├----> [manager_visa_json_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_visa_json_builder.md) — *Manager Visa Json Builder*<br>
     ├----> [manager_visa_known_types](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_visa_known_types.md) — *Manager Visa Known Types*<br>
     ├----> [manager_visa_parse_idn](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/manager_visa_parse_idn.md) — *Manager Visa Parse Idn*<br>
     ├----> [visa_fleet_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/visa_fleet_manager.md) — *Visa Fleet Manager*<br>
     ├----> [visa_proxy_fleet](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Fleet_Manager/visa_proxy_fleet.md) — *Visa Proxy Fleet*<br>
├-----**Visa_Scipi_dialog/**<br>
     ├----> [manager_logic_connect_instrument](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_logic_connect_instrument.md) — *Manager Logic Connect Instrument*<br>
     ├----> [manager_logic_disconnect_instrument](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_logic_disconnect_instrument.md) — *Manager Logic Disconnect Instrument*<br>
     ├----> [manager_logic_mqtt_listen](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_logic_mqtt_listen.md) — *Manager Logic Mqtt Listen*<br>
     ├----> [manager_logic_mqtt_publisher](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_logic_mqtt_publisher.md) — *Manager Logic Mqtt Publisher*<br>
     ├----> [manager_visa](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa.md) — *Manager Visa*<br>
     ├----> [manager_visa_list_visa_resources](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_list_visa_resources.md) — *Manager Visa List Visa Resources*<br>
     ├----> [manager_visa_proxy](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_proxy.md) — *Manager Visa Proxy*<br>
     ├----> [manager_visa_reboot](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_reboot.md) — *Manager Visa Reboot*<br>
     ├----> [manager_visa_reset](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_reset.md) — *Manager Visa Reset*<br>
     ├----> [manager_visa_safe_query](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_safe_query.md) — *Manager Visa Safe Query*<br>
     ├----> [manager_visa_safe_writer](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_safe_writer.md) — *Manager Visa Safe Writer*<br>
     ├----> [manager_visa_search_results](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/manager_visa_search_results.md) — *Manager Visa Search Results*<br>
     ├----> [worker_visa_pre_flight_check](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/Visa_Scipi_dialog/worker_visa_pre_flight_check.md) — *Worker Visa Pre Flight Check*<br>
├-----**configini/**<br>
     ├----> [config_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/configini/config_builder.md) — *Config Builder*<br>
...
├-----**yak/**<br>
     ...
     ├----> [manager_yak_rx](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/yak/manager_yak_rx.md) — *Manager Yak Rx*<br>
     ├----> [manager_yak_tx](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/yak/manager_yak_tx.md) — *Manager Yak Tx*<br>
     ├----> [manager_yakety_yak](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/yak/manager_yakety_yak.md) — *Manager Yakety Yak*<br>
     ├----> [yak_command_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/yak/yak_command_builder.md) — *Yak Command Builder*<br>
...
------[manager_launcher](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/managers/manager_launcher.md) — *Manager Launcher*<br>
**workers/**<br>
├-----**Showtime/**<br>
     ├----> [ptp_time](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/ptp_time.md) — *Ptp Time*<br>
     ├----> [worker_showtime_buttons](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_buttons.md) — *Worker Showtime Buttons*<br>
     ├----> [worker_showtime_clear_group_buttons](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_clear_group_buttons.md) — *Worker Showtime Clear Group Buttons*<br>
     ├----> [worker_showtime_draw_bargraph](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_draw_bargraph.md) — *Worker Showtime Draw Bargraph*<br>
     ├----> [worker_showtime_group](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_group.md) — *Worker Showtime Group*<br>
     ├----> [worker_showtime_on_group_toggle](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_on_group_toggle.md) — *Worker Showtime On Group Toggle*<br>
     ├----> [worker_showtime_on_marker_button_click](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_on_marker_button_click.md) — *Worker Showtime On Marker Button Click*<br>
     ├----> [worker_showtime_on_zone_toggle](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_on_zone_toggle.md) — *Worker Showtime On Zone Toggle*<br>
     ├----> [worker_showtime_read](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_read.md) — *Worker Showtime Read*<br>
     ├----> [worker_showtime_tune](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Showtime/worker_showtime_tune.md) — *Worker Showtime Tune*<br>
├-----**active/**<br>
     ...
     ├----> [XXX-worker_active_peak_publisher](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/active/XXX-worker_active_peak_publisher.md) — *Xxx-Worker Active Peak Publisher*<br>
├-----**builder/**<br>
     ├----> **break_line/**<br>
     ...
     ├----> **breakoff_manager/**<br>
        |   -> [hidden_breakoff_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/breakoff_manager/hidden_breakoff_manager.md) — *Hidden Breakoff Manager*<br>
     ├----> **button_actuator/**<br>
     ...
     ├----> **data_graphing/**<br>
        |   -> [Meter_to_display_units](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/Meter_to_display_units.md) — *Meter To Display Units*<br>
        |   -> [dynamic_bar_graph](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/dynamic_bar_graph.md) — *Dynamic Bar Graph*<br>
        |   -> [dynamic_graph](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/dynamic_graph.md) — *Dynamic Graph*<br>
        |   -> [graph_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/graph_builder.md) — *Graph Builder*<br>
        |   -> [graph_interactor](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/graph_interactor.md) — *Graph Interactor*<br>
        |   -> [graph_styler](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/graph_styler.md) — *Graph Styler*<br>
        |   -> [graph_updater](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/graph_updater.md) — *Graph Updater*<br>
        |   -> [meter_widget_adapter](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/meter_widget_adapter.md) — *Meter Widget Adapter*<br>
        |   -> [plot_widget_adapter](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_graphing/plot_widget_adapter.md) — *Plot Widget Adapter*<br>
     ├----> **data_json_tree/**<br>
        |   -> [data_json_tree](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_json_tree/data_json_tree.md) — *Data Json Tree*<br>
     ├----> **data_radar/**<br>
        |   -> [data_radar](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/data_radar/data_radar.md) — *Data Radar*<br>
     ├----> **fader/**<br>
        |   -> **core/**<br>
     ...
     ├----> **text_table/**<br>
        ...
        |   -> [table_editing_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/builder/text_table/table_editing_manager.md) — *Table Editing Manager*<br>
...
├-----**exporters/**<br>
     ...
     ├----> [worker_file_csv_export](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/exporters/worker_file_csv_export.md) — *Worker File Csv Export*<br>
├-----**handlers/**<br>
...
├-----**importers/**<br>
     ├----> **formats/**<br>
        |   -> [worker_importer_from_csv_unknown](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_csv_unknown.md) — *Worker Importer From Csv Unknown*<br>
        |   -> [worker_importer_from_ias_html](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_ias_html.md) — *Worker Importer From Ias Html*<br>
        |   -> [worker_importer_from_shure_wwb_shw](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_shure_wwb_shw.md) — *Worker Importer From Shure Wwb Shw*<br>
        |   -> [worker_importer_from_shure_wwb_zip](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_shure_wwb_zip.md) — *Worker Importer From Shure Wwb Zip*<br>
        |   -> [worker_importer_from_soundbase_pdf_v1](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_soundbase_pdf_v1.md) — *Worker Importer From Soundbase Pdf V1*<br>
        |   -> [worker_importer_from_soundbase_pdf_v2](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/formats/worker_importer_from_soundbase_pdf_v2.md) — *Worker Importer From Soundbase Pdf V2*<br>
     ├----> [worker_importer_appender](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_importer_appender.md) — *Worker Importer Appender*<br>
     ├----> [worker_importer_editor](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_importer_editor.md) — *Worker Importer Editor*<br>
     ├----> [worker_importer_loader](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_importer_loader.md) — *Worker Importer Loader*<br>
     ├----> [worker_importer_saver](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_importer_saver.md) — *Worker Importer Saver*<br>
     ├----> [worker_marker_csv_to_json_mqtt](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_marker_csv_to_json_mqtt.md) — *Worker Marker Csv To Json Mqtt*<br>
     ├----> [worker_marker_file_import_converter](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/importers/worker_marker_file_import_converter.md) — *Worker Marker File Import Converter*<br>
├-----**initialization/**<br>
     ...
     ├----> [worker_project_paths](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/initialization/worker_project_paths.md) — *Worker Project Paths*<br>
├-----**logger/**<br>
...
├-----**markers/**<br>
     ...
     ├----> [worker_marker_logic](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/markers/worker_marker_logic.md) — *Worker Marker Logic*<br>
├-----**monitoring/**<br>
...
├-----**presets/**<br>
     ...
     ├----> [XXXworker_preset_from_device](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/presets/XXXworker_preset_from_device.md) — *Xxxworker Preset From Device*<br>
├-----**splash_screen/**<br>
     ├----> [lyrics_data](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/splash_screen/lyrics_data.md) — *Lyrics Data*<br>
...
├-----**wysiwyg_editor/**<br>
     ├----> **core/**<br>
        ...
        |   -> [state_manager](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/wysiwyg_editor/core/state_manager.md) — *State Manager*<br>
     ├----> **grab_bag/**<br>
     ...
     ├----> [run_builder](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/wysiwyg_editor/run_builder.md) — *Run Builder*<br>
    ...
    ├----> [Worker_Launcher](https://github.com/LikeDotAudio/OPEN-AIR/blob/main/workers/Worker_Launcher.md) — *Worker Launcher*<br>
