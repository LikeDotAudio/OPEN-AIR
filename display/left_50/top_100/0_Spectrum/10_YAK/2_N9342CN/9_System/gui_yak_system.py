...
class GenericInstrumentGui(ttk.Frame):
    ...
    #     json_path (str, optional): Path to the JSON configuration file for this GUI.
    #     config (dict, optional): A dictionary containing configuration data, including
    #                              state_mirror_engine and subscriber_router.
    ...
    # uses the DynamicGuiBuilder to instantiate and arrange all the widgets.
    # It
