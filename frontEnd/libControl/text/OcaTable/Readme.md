...
Tabular display fed by an object-of-objects or array-of-objects, with configured
headers. Updates from `value`.

- **Defines (global):** `OcaTable`
- **Props:** `value` (data), `config` (`headers`, `description`, `data`)
