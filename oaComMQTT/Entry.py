...
def run_tests():
    """
    Discovers and runs all tests within the oaComMQTT/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaComMQTT...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaComMQTT passed!")
    else:
        print("\n💔 Some tests for oaComMQTT failed.")
