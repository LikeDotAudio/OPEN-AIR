...
class TestMqttManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('oaComMQTT.Managers.mqtt_manager.delete_open_air_tree'):
            with patch('oaComMQTT.Managers.mqtt_manager.register_service'):
                with patch('oaComMQTT.Managers.mqtt_manager.re_register_all_services'):
        ...
        self.patcher_app_paths = patch('oaComMQTT.Managers.mqtt_manager.app_paths', self.mock_app_paths)
        self.mock_app_paths_obj = self.patcher_app_paths.start()

        self.patcher_app_constants = patch('oaComMQTT.Managers.mqtt_manager.app_constants', self.mock_app_constants)
        ...
        self.patcher_matrix_log = patch('oaComMQTT.Managers.mqtt_manager.matrix_log')
    ...
    @patch('oaComMQTT.Managers.mqtt_manager.re_register_all_services')
    @patch('oaComMQTT.Managers.mqtt_manager.register_service')
    ...
    @patch('oaComMQTT.Managers.mqtt_manager.MqttManager._attempt_reconnect')
