...
def run_tests():
    """
    Discovers and runs all tests within the oaComMidi/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaComMidi...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaComMidi passed!")
    else:
        print("\n💔 Some tests for oaComMidi failed.")
