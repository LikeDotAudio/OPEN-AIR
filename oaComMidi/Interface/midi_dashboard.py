# Interface/midi_dashboard.py
# Author: Anthony Peter Kuzub
# Version: 20260323.Robust.1
#
# Description: MIDI Port & Activity Dashboard Plugin for OPEN-AIR.
# Refactored as a standalone component within the oaComMidi partition.
