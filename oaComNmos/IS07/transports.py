...
from oaComWebsocket.Core.abc import EventTransport
# Import the WebSocketEventTransport from its new centralized location
from oaComWebsocket.Core.websocket_transport import WebSocketEventTransport
...
from oaComNmos.Core.IS07.core_models import Message, EventCore, Identity, Timing, BooleanPayload, StringPayload, NumberPayload, ObjectPayload, GenericTypeDefinition
from oaComNmos.Constants import settings
from oaComNmos.Managers import registration_manager
from oaComNmos.Core.IS07.core_models import STREAMS # Access shared state dict from core_models

# --- Abstract Base Classes for Transports ---

# EventTransport class is now imported from oaComWebsocket.Core.abc
...
# The WebSocketEventTransport class has been moved to oaComWebsocket.Core.websocket_transport
