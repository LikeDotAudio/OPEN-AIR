...
def run_tests():
    """
    Discovers and runs all tests within the oaComOSC/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaComOSC...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaComOSC passed!")
    else:
        print("\n💔 Some tests for oaComOSC failed.")
