# oaComProtocols.oaComAES70/Methods/oaAES70Core_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oaaes70core_rs. 
...
def ensure_compiled():
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oaaes70core_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oaaes70core_rs".replace("_", "-")
