# 🎹 oaComProtocols.oaComMidi: MIDI Communication Module

## 📖 Overview
The `oaComProtocols.oaComMidi` package is responsible for bidirectional communication between the OPEN-AIR system and MIDI-enabled hardware. It abstracts the complexities of raw MIDI protocols and provides a unified, topic-based interface for the rest of the application.
...
```python
from oaComProtocols.oaComMidi import Entry as midi_api
midi_api.start()
```
