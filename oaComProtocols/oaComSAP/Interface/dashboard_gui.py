...
class ProtocolDashboard(tk.Frame):
    def __init__(self, parent, config, json_path=None, protocol_name="SAP", *args, **kwargs):
        ...
        self.rx_tree = ttk.Treeview(self.rx_frame, columns=("Time", "Source", "Summary"), show="headings")
        self.rx_tree.heading("Time", text="Time")
        self.rx_tree.heading("Source", text="Source")
        self.rx_tree.heading("Summary", text="Summary")
    ...
    def log_rx(self, source, summary, details):
        ...
        item_id = self.rx_tree.insert("", 0, values=(now, source, summary))
