# oaComProtocols.oaComVisa/Tests/test_agent_mdns_zeroconf.py
...
class TestAgentMdnsZeroconf(unittest.TestCase):
    ...
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf.Zeroconf')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf.ServiceBrowser')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf.time.sleep')
    ...
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf._get_local_ip')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf._check_host')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf.discover_aes70_devices')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf.ThreadPoolExecutor')
    ...
    @patch('socket.socket')
    @patch('oaComProtocols.oaComVisa.Workers.agent_mdns_zeroconf._get_local_ip', return_value="192.168.1.50")
