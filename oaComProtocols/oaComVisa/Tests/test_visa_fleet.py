...
class TestVisaFleet(unittest.TestCase):
    def setUp(self):
        ...
        with patch("oaComProtocols.oaComVisa.Core.visa_fleet.DiscoveryOrchestrator"), \
             patch("oaComProtocols.oaComVisa.Core.visa_fleet.VisaJsonBuilder.load_inventory_from_json", return_value=[]):
