...
def run_tests():
    """
    Discovers and runs all tests within the oaComSMPTE2138/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaComSMPTE2138...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaComSMPTE2138 passed!")
    else:
        print("\n💔 Some tests for oaComSMPTE2138 failed.")
