...
def run_tests():
    """
    Discovers and runs all tests within the oaComVisa/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaComVisa...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaComVisa passed!")
    else:
        print("\n💔 Some tests for oaComVisa failed.")
