# oaComVisa/Tests/test_discovery_orchestrator.py
...
from oaComVisa.Managers.discovery_orchestrator import DiscoveryOrchestrator
...
class TestDiscoveryOrchestrator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('oaComVisa.Managers.discovery_orchestrator.VisaScanner')
