# oaComVisa/Tests/test_logic_connect_instrument.py
...
from oaComVisa.Workers.logic_connect_instrument import VisaConnector
...
class TestVisaConnector(unittest.TestCase):
    ...
    @patch('oaComVisa.Workers.logic_connect_instrument.pyvisa.ResourceManager')
