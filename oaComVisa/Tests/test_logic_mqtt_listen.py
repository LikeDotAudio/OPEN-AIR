# oaComVisa/Tests/test_logic_mqtt_listen.py
...
from oaComVisa.Workers.logic_mqtt_listen import VisaMqttListener, MQTT_TOPIC_SEARCH_TRIGGER, MQTT_TOPIC_DEVICE_SELECT
