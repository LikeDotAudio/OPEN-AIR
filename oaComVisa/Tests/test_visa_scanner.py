# oaComVisa/Tests/test_visa_scanner.py
...
from oaComVisa.Workers.visa_scanner import VisaScanner
...
class TestVisaScanner(unittest.TestCase):
    ...
    @patch('oaComVisa.Workers.visa_scanner.get_local_ip')
    @patch('oaComVisa.Workers.visa_scanner.check_host')
    @patch('oaComVisa.Workers.visa_scanner.ThreadPoolExecutor')
    ...
    @patch('oaComVisa.Workers.visa_scanner.KNOWN_DEVICES', {"MSO2024B": {"type": "Oscilloscope", "notes": "Tested"}})
