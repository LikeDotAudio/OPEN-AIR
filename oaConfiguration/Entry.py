...
def run_tests():
    """
    Discovers and runs all tests within the oaConfiguration/Tests/ directory.
    """
    print("Discovering and running tests for oaConfiguration...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaConfiguration passed!")
    else:
        print("\n💔 Some tests for oaConfiguration failed.")
