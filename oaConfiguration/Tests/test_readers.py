# oaConfiguration/Tests/test_readers.py
# Author: Anthony Peter Kuzub
# Version: 1.0.0
#
# Description: Unit tests for FileReaders in oaConfiguration.

import unittest
from pathlib import Path
from oaConfiguration.Core.config_loader import ConfigLoader

class TestConfigReader(unittest.TestCase):
    """
    Harden FileReaders for oaConfiguration.
    """
