# oaConfigurationManager/Methods/oaConfigEngine_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oaconfigengine_rs.oaconfigengine_rs. 
...
def ensure_compiled():
    ...
    try:
        import oaconfigengine_rs.oaconfigengine_rs
        return
    except ImportError:
        pass
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oaconfigengine_rs.oaconfigengine_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oaconfigengine_rs.oaconfigengine_rs".replace("_", "-")
