...
def run_tests():
    """
    Discovers and runs all tests within the oaFileImportHTML/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaFileImportHTML...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaFileImportHTML passed!")
    else:
        print("\n💔 Some tests for oaFileImportHTML failed.")
