# oaFileImportHTML/Methods/oaHTMLScraper_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oahtmlscraper_rs. 
...
def ensure_compiled():
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oahtmlscraper_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oahtmlscraper_rs".replace("_", "-")
