# 🏷️ Worker Importer From Soundbase Pdf V2
...
### Global Functions
#### `Marker_convert_SB_v2_PDF_File_report_to_csv(pdf_file_path)`
Parses a PDF file (Sound Base v2 format) and extracts frequency data, converting
it
into a standardized CSV format.
