# oaFileImportPDF/Methods/oaPDFParser_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oapdfparser_rs.oapdfparser_rs. 
...
def ensure_compiled():
    ...
    try:
        import oapdfparser_rs.oapdfparser_rs
        return
    except ImportError:
        pass
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oapdfparser_rs.oapdfparser_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oapdfparser_rs.oapdfparser_rs".replace("_", "-")
