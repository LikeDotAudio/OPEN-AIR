# /home/anthony/Documents/OPEN-AIR/oaGui/Assets/Assets/right_50/bottom_90/44_REST/__init__.py
# This __init__.py file acts as a pointer to the actual implementation of gui_REST.py
# located in the oaComProtocols.oaComREST module's Interface directory.

try:
    # Import the actual implementation from the new location
    from oaComProtocols.oaComREST.Interface.gui_REST import RestDashboard as OriginalRestDashboard
    from oaComProtocols.oaComREST.Interface.gui_REST import get_gui_class as original_get_gui_class
    ...
    print(f"Error importing RestDashboard from oaComProtocols.oaComREST.Interface: {e}")
    print("Ensure oaComProtocols.oaComREST module and its Interface directory are correctly set up.")
