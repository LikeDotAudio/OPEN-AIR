# /home/anthony/Documents/OPEN-AIR/oaGui/Assets/Assets/right_50/bottom_90/2138_SMPTE_2138/__init__.py
# This __init__.py file acts as a pointer to the actual implementation of smpte2138_monitor.py
# located in the oaComProtocols.oaComSMPTE2138 module's Interface directory.

try:
    # Import the actual implementation from the new location
    from oaComProtocols.oaComSMPTE2138.Interface.smpte2138_monitor import SMPTE2138Monitor as OriginalSMPTE2138Monitor
    from oaComProtocols.oaComSMPTE2138.Interface.smpte2138_monitor import get_gui_class as original_get_gui_class
    ...
    print(f"Error importing SMPTE2138Monitor from oaComProtocols.oaComSMPTE2138.Interface: {e}")
    print("Ensure oaComProtocols.oaComSMPTE2138 module and its Interface directory are correctly set up.")
