# /home/anthony/Documents/OPEN-AIR/oaGui/Assets/Assets/right_50/bottom_90/66_NMOS/01_Websockets/nmos_websockets.py
# This file serves as a discovery point for the NMOS WebSocket Manager GUI.
# The primary implementation logic resides in oaComProtocols.oaComNmos.Interface.nmos_websocket_manager_impl.

import tkinter as tk
# Import the actual GUI implementation class
from oaComProtocols.oaComNmos.Interface import NmosWebsocketManagerImplementation
