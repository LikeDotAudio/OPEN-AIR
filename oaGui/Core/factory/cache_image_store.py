...
class CacheImageStore:
    ...
    def invalidate_cache(cls):
        ...
        matrix_log("UI", "GUI_MANAGER", inspect.currentframe().f_code.co_name, "♻️ CacheImageStore: Memory cache cleared.", level="INFO")
