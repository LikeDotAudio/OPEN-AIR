# oaGui/Core/telemetry/ui_tracking_service.py
...
from oaGui.Methods.telemetry_publisher import TelemetryPublisher
...
class UITrackingService:
    ...
    def _perform_geometry_publish(self, widget):
        ...
        try:
            ...
            TelemetryPublisher.publish_geometry(meta["engine"], meta["geo_topic"], meta["tab_name"], (w, h, x, y))
