# oaGui/Tests/test_geometry_math_rust.py
#
...
class TestGeometryMathRust(unittest.TestCase):
    def test_rust_normalize_value(self):
        ...
        self.assertEqual(CoordinateTransformer.normalize_value(50, 0, 100), 0.5)
        self.assertEqual(CoordinateTransformer.normalize_value(0, 0, 100), 0.0)
        self.assertEqual(CoordinateTransformer.normalize_value(100, 0, 100), 1.0)
        # Clamping isn't explicitly in the code but division would happen
        self.assertEqual(CoordinateTransformer.normalize_value(150, 0, 100), 1.5)
    ...
    def test_rust_rotate_point(self):
        ...
        nx, ny = CoordinateTransformer.rotate_point(100, 0, 0, 0, 90)
    ...
    def test_rust_get_position(self):
        ...
        x, y = CoordinateTransformer.get_position(0, 100, 0, 0)
    ...
    def test_rust_get_angle(self):
        ...
        angle = CoordinateTransformer.get_angle(0, 100, 0, 0)
