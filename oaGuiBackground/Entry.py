...
"""
oaGuiBackground/Entry.py - Gatekeeper for oaGuiBackground
"""

def run_tests():
    """
    Discovers and runs all tests within the oaGuiBackground/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiBackground...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiBackground passed!")
    else:
        print("\n💔 Some tests for oaGuiBackground failed.")
