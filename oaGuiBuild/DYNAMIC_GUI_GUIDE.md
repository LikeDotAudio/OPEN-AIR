...
This guide explains how the OPEN-AIR dynamic GUI system works, how to create new interfaces using JSON blueprints, and how the various components in the `oaGuiDefinitions/` directory interact.
...
Place your JSON file in an appropriate directory (e.g., `oaGuiDefinitions/left_50/top_100/your_module/gui_your_module.json`).
