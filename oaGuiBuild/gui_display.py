...
# --- Module Imports ---
from oaGuiBuild.window import WindowManager
from oaGuiManager.loader.module_loader import ModuleLoader
from oaGuiManager.parser.layout_parser import LayoutParser
from oaStyle.style import THEMES, DEFAULT_THEME
from oaOchestration.project_paths import LAYOUT_CACHE_PATH
from oaGuiManager.factory.widget_registry import WidgetRegistry

# --- EXTRACTED CORE MODULES ---
from oaGuiBuild.core.layout_cache import LayoutCacheManager
from oaGuiBuild.core.directory import DirectoryBuilderMixin
from oaGuiBuild.core.tab import TabManagerMixin
from oaGuiBuild.core.navigation import NavigationManagerMixin
...
class Application(
    ...
    def _apply_styles(self, theme_name: str):
        from oaStyle.theme_applier import apply_theme
