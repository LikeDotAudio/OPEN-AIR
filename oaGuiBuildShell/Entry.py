...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiBuildShell/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiBuildShell...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiBuildShell passed!")
    else:
        print("\n💔 Some tests for oaGuiBuildShell failed.")
