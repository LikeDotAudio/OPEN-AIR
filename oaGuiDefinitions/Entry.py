...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiDefinitions/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiDefinitions...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiDefinitions passed!")
    else:
        print("\n💔 Some tests for oaGuiDefinitions failed.")
