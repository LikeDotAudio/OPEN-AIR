# oaGuiElements/Core/images/images_progress_bar/Interface/images_progress_bar_editor.py
# Author: Gemini CLI
...
class ImagesProgressBarEditor:
    ...
    def __init__(self, parent, config_data, on_save_callback):
        ...
        self.window.title(f"Editor: {self.current_config.get('path', 'images_progress_bar')}")
    ...
    def launch(parent, config_data, on_save_callback):
        return ImagesProgressBarEditor(parent, config_data, on_save_callback)
