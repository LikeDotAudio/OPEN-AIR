...
class MeterConfig:
    ...
    def from_dict(cls, config: Dict[str, Any]):
        ...
        return cls(
            ...
            bg_color=get_text(flat_cfg.get("bg", base_bg)),
            canvas_bg=get_text(flat_cfg.get("bg", base_bg)),
            lower_colour=get_text(c_colors.get("lower", c_colors.get("primary", config.get("Lower_range_colour", "green")))),
            middle_colour=get_text(c_colors.get("middle", c_colors.get("secondary", config.get("Middle_range_colour", "yellow")))),
            upper_colour=get_text(c_colors.get("upper", c_colors.get("alert", config.get("upper_range_Colour", "red")))),
            peak_display_colour=get_text(c_colors.get("Peak_alert", c_colors.get("Overload_alert", overload_cfg.get("Peak_display_colour", config.get("Peak_display_colour", "red"))))),
            pointer_colour=get_text(c_colors.get("pointer", config.get("Pointer_colour", "white"))),
            tick_colour=get_text(c_colors.get("tick", config.get("tick_color", def_fg))),
            sub_tick_colour=get_text(c_colors.get("sub_tick", c_colors.get("tick", config.get("tick_color", def_fg)))),
            grid_colour=get_text(c_colors.get("grid", "#444444")),
            scale_text_colour=get_text(c_colors.get("scale", c_colors.get("tick", config.get("tick_color", def_fg)))),
            label_colour=get_text(c_colors.get("label", def_fg)),
            bar_track_bg=get_text(c_colors.get("background", flat_cfg.get("bg", base_bg)))
        )