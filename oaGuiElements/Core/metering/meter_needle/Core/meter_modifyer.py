...
from ..cosmetics.bezel import BezelOverlay
from ..cosmetics.label import BezelLabel
from ..cosmetics.lighting_overlay import VintageLightingGenerator
from ..cosmetics.mask import BezelMask
...
class MeterModifier:
    ...
    def draw_background_faceplate(canvas, cx, cy, w, h, cosmetics):
        ...
        pass # BezelBackground.draw(canvas, cx, cy, w, h, cosmetics)
