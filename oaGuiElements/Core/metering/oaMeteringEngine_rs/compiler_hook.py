# oaGuiElements/Core/metering/oaMeteringEngine_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oameteringengine_rs. 
...
def ensure_compiled():
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oameteringengine_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oameteringengine_rs".replace("_", "-")
