...
### Global Functions
#### `bind_wink_events(canvas, state, config, value_var, draw_visuals_callback, broadcast_callback)`
...
- `value_var`: [TODO: Detail the precise meaning, valid ranges, and special cases]
