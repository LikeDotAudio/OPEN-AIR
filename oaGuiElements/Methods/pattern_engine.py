# oaGuiElements/Methods/pattern_engine.py
...
try:
    ...
    logging.error(f"oaGuiElements: Failed to load Rust Pattern Engine: {e}")
    HAS_RUST = False
...
class PatternEngine:
    ...
    def __init__(self):
        if HAS_RUST:
            ...
            self._engine = None
            logging.warning("oaGuiElements: Using legacy/missing pattern engine (No Rust).")
