...
class TestKnobWidget(unittest.TestCase):
    def setUp(self):
        ...
        with patch("oaGuiElements.Core.utils.knob.knob.extract_knob_config", return_value={
