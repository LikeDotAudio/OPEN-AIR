...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiFolderParser/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiFolderParser...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiFolderParser passed!")
    else:
        print("\n💔 Some tests for oaGuiFolderParser failed.")
