...
class TestUniversalGuiLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_json_path_success = "oaGuiManager/Tests/Assets/sample.json"
        self.test_json_path_fail = "oaGuiManager/Tests/Assets/nonexistent.json"
        self.mock_config = {"app_instance": MagicMock()}

    # Patch DynamicGuiBuilder within the module where it's used: gui_from_json.py
    @patch('oaGuiManager.Core.loader.gui_from_json.DynamicGuiBuilder')
