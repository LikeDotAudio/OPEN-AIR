...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiMediaElements/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiMediaElements...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiMediaElements passed!")
    else:
        print("\n💔 Some tests for oaGuiMediaElements failed.")
