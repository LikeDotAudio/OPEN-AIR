...
This module processes and groups marker data by Zone, Group, and Device for
display in the Showtime tab.
...
### Global Functions
#### `process_and_sort_markers(showtime_tab_instance)`
