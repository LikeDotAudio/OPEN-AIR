...
This module provides the logic for loading marker data from a file into the
Showtime tab, preparing it for display and interaction.
...
### Global Functions
#### `load_marker_data(showtime_tab_instance)`
