...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiShowtime/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiShowtime...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiShowtime passed!")
    else:
        print("\n💔 Some tests for oaGuiShowtime failed.")
