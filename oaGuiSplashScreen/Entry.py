...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiSplashScreen/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiSplashScreen...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiSplashScreen passed!")
    else:
        print("\n💔 Some tests for oaGuiSplashScreen failed.")
