...
def run_tests():
    """
    Discovers and runs all tests within the oaGuiTelemetry/Tests/ directory.
    """
    print("🔍 Discovering and running tests for oaGuiTelemetry...")
    ...
    if all_tests_passed:
        print("\n🎉 All tests for oaGuiTelemetry passed!")
    else:
        print("\n💔 Some tests for oaGuiTelemetry failed.")
