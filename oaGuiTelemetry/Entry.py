# oaGuiTelemetry/Entry.py
# Author: Anthony Peter Kuzub
# Version: 20260415.2210.1
#
# Description: Gatekeeper for the oaGuiTelemetry module.
...
from oaGuiTelemetry.Core.telemetry_service import TelemetryService
...
def start():
    ...
    service.start()
    print("🚀 [START] Telemetry services started.")
    return service
...
def stop():
    ...
    service = TelemetryService.get_instance()
    service.stop()
    print("🛑 [STOP] Telemetry services stopped.")

def status():
    """Returns the status of the telemetry service."""
    service = TelemetryService.get_instance()
    return "active" if service.is_running() else "inactive"
