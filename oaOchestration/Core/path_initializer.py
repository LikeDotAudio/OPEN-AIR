...
def initialize_paths():
    ...
    """
    global GLOBAL_PROJECT_ROOT, DATA_RUNNING_DIR, DATA_LOGS_DIR, DATA_CACHE_DIR, DATA_SNMP_DIR, DATA_SPLINKS_DIR, DATA_REPORTS_DIR, GUI_FRAMES_DIR
    ...
    GUI_FRAMES_DIR = GLOBAL_PROJECT_ROOT / "Gui_Frames"
    ...
    GUI_FRAMES_DIR.mkdir(parents=True, exist_ok=True)
