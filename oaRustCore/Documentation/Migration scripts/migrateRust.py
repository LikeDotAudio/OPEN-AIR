...
CRATES = [
    ...
    "oaGuiBuilder/Core/oaGeometryMath_rs",
    ...
    "oaGuiManager/Core/oaFastScanner_rs",
    "oaGuiManager/FileReaders/oaBlueprintParser_rs",
    "oaGuiMediaElements/Methods/oaImageScaler_rs",
    "oaGuiTelemetry/Methods/oaTimeSeriesDB_rs",
