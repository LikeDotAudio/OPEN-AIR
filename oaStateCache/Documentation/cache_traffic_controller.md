...
Acts as a middleware for incoming MQTT messages, decoding payloads and
determining if cache updates are necessary.
...
### Global Functions
#### `process_traffic(msg, current_cache)`
...
- `current_cache`: [TODO: Detail the precise meaning, valid ranges, and special cases]
