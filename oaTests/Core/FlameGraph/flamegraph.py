...
def synthesize_report(mtp):
    ...
    mtp.stop()
    print("? OpenAir closed or frozen. Synthesizing Intelligence Report...")
    ...
    print("" + wall_of_pitty_text[:1000] + "...[Report Truncated - Open HTML for full details]")
...
def main():
    ...
    if importlib.util.find_spec(watchdog_path):
        from oaWatchdog.watchdog import register_panic_callback
