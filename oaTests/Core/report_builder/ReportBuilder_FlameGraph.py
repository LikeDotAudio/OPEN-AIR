...
import json
import pathlib
from oaTests.Core.FlameGraph.flame_events import generate_table_rows
...
def build_tab(project_root):
    ...
    try:
        ...
        # 4. Load Template
        template_path = os.path.join(project_root, "oaTests", "Core", "FlameGraph", "templates", "report_template.html")
