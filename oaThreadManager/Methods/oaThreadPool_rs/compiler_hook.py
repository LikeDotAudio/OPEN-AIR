# oaThreadManager/Methods/oaThreadPool_rs/compiler_hook.py
# Author: Gemini (Collaborator)
# Version: 20260406.1300.2
#
# Description: Compiler hook for oathreadpool_rs.oathreadpool_rs. 
...
def ensure_compiled():
    ...
    try:
        import oathreadpool_rs.oathreadpool_rs
        return
    except ImportError:
        pass
    ...
    try:
        ...
        wheels = glob.glob(os.path.join(module_dir, "target", "wheels", "oathreadpool_rs.oathreadpool_rs-*.whl"))
        if not wheels:
            # Try with hyphens replaced by underscores or vice versa
            normalized = "oathreadpool_rs.oathreadpool_rs".replace("_", "-")
