...
def ensure_compiled():
    ...
    print("🦀 Compiling oathreadpool_rs...")
    ...
    if os.path.exists(venv_python):
        subprocess.run([venv_python, "-m", "pip", "uninstall", "-y", "oathreadpool_rs"], cwd=crate_dir, check=False, env=env)
    ...
    try:
        ...
        print(f"❌ Failed to compile or import oathreadpool_rs: {e}")
        raise e
