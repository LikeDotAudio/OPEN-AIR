# workers/Command_Router/SNMP/snmp_tree_builder.py
import os
import stat
from loguru import logger
from managers.configini.config_reader import Config
from workers.initialization.worker_project_paths import SNMP_STATE_FILE, SNMP_SET_LOG
...
class SNMPTreeBuilder:
    def __init__(self, base_oid=".1.3.6.1.4.1.25030"):
        ...
        self.script_dir = "DATA/snmp/pass_scripts"
