...
#     if LOCAL_DEBUG: logger.debug(f"▶️ update_top_plot with plot_title: {plot_title}")
# 
#     try:
...
# 
#         canvas.draw()
#         if LOCAL_DEBUG: logger.success("✅ Top plot updated.")
#     except Exception:
#         logger.exception("❌ Error in update_top_plot")
# 
# 
...
#     if LOCAL_DEBUG: logger.debug(f"▶️ update_middle_plot with plot_title: {plot_title}")
# 
#     try:
...
# 
#         canvas.draw()
#         if LOCAL_DEBUG: logger.success("✅ Middle plot updated.")
#     except Exception:
#         logger.exception("❌ Error in update_middle_plot")
# 
# 
...
#     if LOCAL_DEBUG: logger.debug(f"▶️ update_bottom_plot with plot_title: {plot_title}")
# 
#     try:
...
# 
#         canvas.draw()
#         if LOCAL_DEBUG: logger.success("✅ Bottom plot updated.")
#     except Exception:
#         logger.exception("❌ Error in update_bottom_plot")
# 
# 
# def clear_monitor_plots(scan_monitor_tab_instance):
#     """Clears all three plots in the Scan Monitor tab."""
#     if LOCAL_DEBUG: logger.debug("▶️ clear_monitor_plots.")
# 
#     try:
#         if not scan_monitor_tab_instance:
#             logger.error("❌ Scan Monitor tab instance could not be found. Cannot clear plots.")
#             return
# 
...
#                 canvas.draw()
# 
#         if LOCAL_DEBUG: logger.success("✅ All monitor plots cleared.")
#     except Exception:
#         logger.exception("❌ Error in clear_monitor_plots")
