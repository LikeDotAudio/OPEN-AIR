...
This module provides functions for setting up interactive features on Matplotlib
graphs, including zoom, pan, and hover annotations.
...
- `annot`: [TODO: Detail the precise meaning, valid ranges, and special cases]
...
#### `setup_interaction(fig, ax, interaction_config, callbacks)`
...
- `ax`: [TODO: Detail the precise meaning, valid ranges, and special cases]
- `interaction_config`: [TODO: Detail the precise meaning, valid ranges, and special cases]
- `callbacks`: [TODO: Detail the precise meaning, valid ranges, and special cases]
...
##### `__init__(self, ax, callbacks, on_context_menu)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]

**Parameters:**
- `ax`: [TODO: Detail meaning, valid ranges, special cases]
- `callbacks`: [TODO: Detail meaning, valid ranges, special cases]
- `on_context_menu`: [TODO: Detail meaning, valid ranges, special cases]
