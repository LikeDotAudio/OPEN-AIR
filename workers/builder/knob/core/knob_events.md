...
### Global Functions
#### `bind_knob_events(canvas, frame, state, config, knob_value_var, draw_visuals_callback, broadcast_callback)`
...
- `knob_value_var`: [TODO: Detail the precise meaning, valid ranges, and special cases]
- `draw_visuals_callback`: [TODO: Detail the precise meaning, valid ranges, and special cases]
- `broadcast_callback`: [TODO: Detail the precise meaning, valid ranges, and special cases]
