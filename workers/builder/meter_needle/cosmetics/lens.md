...
##### `draw(canvas, cx, cy, w, h, cosmetics)`
...
##### `_blend_colors(c1, c2, f)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]

**Parameters:**
- `c1`: [TODO: Detail meaning, valid ranges, special cases]
- `c2`: [TODO: Detail meaning, valid ranges, special cases]
