...
## 📖 Description & Purpose
### File Level
slider_value/gui_slider_value.py

This file provides the BuilderSliderValueCreator class for creating slider
widgets with text entry in the GUI.
...
### Classes
#### `class BuilderSliderValueCreator`
