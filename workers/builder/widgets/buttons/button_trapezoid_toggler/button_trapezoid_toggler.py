# button_trapezoid_toggler/trapezoid_toggler.py
#
...
from workers.builder.widgets.buttons.button_trapezoid.button_trapezoid import BuilderButtonTrapezoidCreator
...
class BuilderButtonTrapezoidTogglerCreator(BuilderButtonTrapezoidCreator):
    ...
    def make_button_trapezoid_toggler(
        ...
        for key, button_config in options.items():
            ...
            bool_var = tk.BooleanVar(value=(selected_var.get() == key))
