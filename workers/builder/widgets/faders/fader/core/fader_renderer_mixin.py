...
from workers.builder.widgets.faders.fader.core.scale import ScaleDrawer
from workers.builder.widgets.faders.fader.core.track import TrackDrawer
from workers.builder.widgets.faders.fader.core.cap import CapDrawer
