...
## 📖 Description & Purpose
### File Level
data_graphing/meter_widget_adapter.py
...
##### `_create_horizontal_meter(self, parent_widget, config_data, **kwargs)`
...
##### `_create_vertical_meter(self, parent_widget, config_data, **kwargs)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
