# images_animation_display/dynamic_guimake_images_animation_display.py
#
...
from workers.initialization.path_initializer import (
    GLOBAL_PROJECT_ROOT,
    ...
    def _on_animation_frame_update_mqtt(self, topic, payload):
        ...
        try:
            ...
            if topic.startswith(expected_prefix):
                from workers.Command_Router.mqtt.mqtt_topic_utils import TOPIC_DELIMITER
