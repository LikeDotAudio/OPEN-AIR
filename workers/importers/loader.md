...
This module provides functions for loading marker data from various file formats
...
#### `load_markers_file_action(importer_tab_instance)`
...
#### `load_ias_html_action(importer_tab_instance)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
...
#### `load_wwb_shw_action(importer_tab_instance)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
...
#### `load_wwb_zip_action(importer_tab_instance)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
...
#### `load_sb_pdf_action(importer_tab_instance)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
...
#### `load_sb_v2_pdf_action(importer_tab_instance)`
[TODO: Brief verb-first description. Start with action (e.g., 'Allocates...',
'Parses...').]
