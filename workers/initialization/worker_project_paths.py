...
from workers.initialization.path_initializer import GLOBAL_PROJECT_ROOT, DATA_DIR
...
MARKERS_JSON_PATH = DATA_DIR / "state" / "MARKERS.json"
MARKERS_CSV_PATH = DATA_DIR / "state" / "MARKERS.csv"
DEVICE_STATE_CACHE_PATH = DATA_DIR / "cache" / "device_state_cache.json"
LAYOUT_CACHE_PATH = DATA_DIR / "cache" / "layout_cache.json"
STATE_VISA_FLEET_JSON_PATH = DATA_DIR / "state" / "STATE_VISA_FLEET.json"
QUERY_DATA_DIR = DATA_DIR / "cache" / "query_data"
TABLES_DIR = DATA_DIR / "cache" / "Tables"
YAKETY_YAK_REPO_PATH = DATA_DIR / "state" / "YAKETYYAK.json"
PRESET_REPO_PATH = DATA_DIR / "state" / "PRESET.csv"

# --- SNMP Temporary & State Paths ---
SNMP_DATA_DIR = DATA_DIR / "snmp"
