...
Dependencies:
    - workers.logger.logger: For accessing Loguru instance and configuration.
...
from workers.logger.logger import initialize_logging, get_logger, quarantine_logger # Assuming logger module is accessible
...
if __name__ == "__main__":
    ...
    from workers.logger.logger import initialize_logging as mock_init_logging, get_logger as mock_get_logger
