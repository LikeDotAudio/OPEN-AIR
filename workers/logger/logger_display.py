...
def display_debug_message_on_terminal(timestamp: str, level: str, message: str, context_data: dict):
    ...
    clean_context = _clean_context_string(context_data.get('file', '?'), context_data.get('function', '?'))
